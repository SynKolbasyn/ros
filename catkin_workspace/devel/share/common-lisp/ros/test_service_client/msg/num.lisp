...
(cl:in-package test_service_client-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <num>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'num)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name test_service_client-msg:<num> is deprecated: use test_service_client-msg:num instead.")))

(cl:ensure-generic-function 'num-val :lambda-list '(m))
(cl:defmethod num-val ((m <num>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader test_service_client-msg:num-val is deprecated.  Use test_service_client-msg:num instead.")
  (num m))
